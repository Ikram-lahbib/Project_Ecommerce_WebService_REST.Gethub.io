    ...
    <div class="container">
        ...
        <div class="container" style="width:200px;height:160px;position:absolute;">
            ...
            <ul class="list-group" style="width:250px; font-size:20px;">
                ...
                <li class="list-group-item" style="font-size:20px;color:#0b102b;"><a href="All.jsp">All</a></li>
                <li class="list-group-item" style="font-size:20px;color:#0b102b;"><a href="All.jsp">Art</a></li>
                <li class="list-group-item" style="font-size:20px;color:#0b102b;"><a href="All.jsp">Science</a></li>
                <li class="list-group-item" style="font-size:20px;color:#0b102b;"><a href="All.jsp">Phylosophy</a></li>
            </ul>
